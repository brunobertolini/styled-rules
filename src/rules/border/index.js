...
const propTypes = {
	...
	borderWidth: PropTypes.oneOfType([PropTypes.bool, PropTypes.string]),
...
const rules = {
	...
	borderRadius: {
		...
		bottom: ({ theme }) =>
			`border-radius: 0 0 ${theme.dimensions.borderRadius} ${
				theme.dimensions.borderRadius
			};`,
		left: ({ theme }) =>
		...
		topLeft: ({ theme }) =>
			`border-radius: ${theme.dimensions.borderRadius} 0 0 0;`,
		topRight: ({ theme }) =>
			`border-radius: 0 ${theme.dimensions.borderRadius} 0 0;`,
		bottomLeft: ({ theme }) =>
